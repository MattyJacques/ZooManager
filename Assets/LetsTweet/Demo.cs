...
public class Demo : MonoBehaviour 
{
	...
	const string PLAYER_PREFS_TWITTER_USER_ID           = "3056989378";
    const string PLAYER_PREFS_TWITTER_USER_SCREEN_NAME  = "SuperIsHere";
	const string PLAYER_PREFS_TWITTER_USER_TOKEN        = "3056989378-cMFqalsKk8ZKEbiQopsrNNf9pPwmXxwYW4gbDeg";
	const string PLAYER_PREFS_TWITTER_USER_TOKEN_SECRET = "2NjQhXXeLoNybd8HiQN5lsZReJ2sCyIluMlNvbDuW7vTo";
